    ...
    <section id="explore" className="experience-section">
      ...
      <div className="experience-grid">
        <article className="experience-card try-card" onClick={() => onNavigate('try-on')}>
          <div className="experience-image"><img src={asset('sample-face.jpg')} alt="虚拟眼镜试戴"/><span>01</span></div>
        ...
        <article className="experience-card identity-card" onClick={() => onNavigate('identity-test')}>
          <div className="identity-art"><img src={asset('hero-portrait.png')} alt="视觉身份肖像"/><div><b>The Quiet<br/>Strategist</b><small>CALM · THOUGHTFUL · RELIABLE</small></div><span>03</span></div>
